const data = `nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
ggsyj czcrdn oolj sijzp ibzjps asp
vbcs ypgzae xcvpsr ptvb leoxqlq zmpt fhawu yfi tvbp
ejkr qlmag nsz jwprli nhsml asksnug mes
...
aie zkkih fhwu bbn fhpwu wvxxgmd
...
const solution = (line) => {
  ...
  return new Set(splited).size === splited.length ? 1 : 0;
};
